  ...
  <div class="columns">
    <div class="column">
      <ul id="movies">
        ...
        <li>Ali G in da house</li>
        <li>Anchorman</li>
        <li>Alien Marathon</li>
        ...
        <li>Postal</li>
        <li>Amourus full game met nsfw</li>
        <li>Anaconda</li>
        <li>Annihalation</li>
        <li>Austin powers marathon</li>
        <li>21 jumpstreet + 22 jumpstreet</li>
        <li>Apocalypse now</li>
        <li>Apocalypto</li>
        <li>Army of the Dead</li>
        <li>Assault on wallstreet</li>
        <li>Ride Along</li>
        <li>Avatar</li>
        <li>Barnyard</li>
        <li>Batman & Robin</li>
        ...
        <li>Boxcar Bertha</li>
        <li>Braveheart</li>
        <li>Bringing Out the Dead</li>
        <li>Brother Bear 2</li>
        <li>Cape Fear</li>
        <li>Captain America: The 1st Avenger</li>
        <li>Cars 2</li>
        <li>Casino (1995)</li>
        <li>Cats</li>
        <li>Cape Fear</li>
        ...
        <li>Die Hard Marathon (Kerstvakantie)</li>
        <li>Dogdeball a true underdog story</li>
        <li>Double Dragon (1994)</li>
        <li>Dracula</li>
        <li>Drive</li>
        <li>Dumb & Dumber</li>
        ...
        <li>Evil Dead</li>
        <li>Fargo (film)</li>
        <li>Fast & Furious marathon</li>
        <li>Fear and Loathing in Las Vegas</li>
        <li>Find Me Guilty</li>
        <li>Flubber</li>
        <li>Freaked</li>
        ...
        <li>Ghost in the shell (scarlet johansen)</li>
        <li>Gladiator</li>
        <li>Golden eye</li>
        <li>Goodfellas</li>
        <li>Green Lantern</li>
        ...
        <li>Hardcore Henry</li>
        <li>Harold & Kumar</li>
        <li>Hercules in New York</li>
        <li>Highlander</li>
        <li>Hitman's bodyguard</li>
        <li>Hobo with a shotgun</li>
        ...
        <li>Journey 1 en 2</li>
        <li>Johnny English</li>
        <li>Jude Law Marathon</li>
        <li>Judge Dredd</li>
        <li>Jupiter Ascending</li>
        <li>Kangaroo Jack</li>
        <li>Kill Bill</li>
        <li>Killer clowns from outer space</li>
        <li>Killer Tomatoes ding</li>
        ...
        <li>Legion</li>
        <li>Leprechaun in the Hood</li>
        <li>Lethal Weapon</li>
        <li>Let’s be Evil</li>
        <li>Lord of the Rings Extended Marathon</li>
        <li>Machete</li>
        <li>Max Payne (2008)</li>
        <li>Mad Max marathon</li>
        <li>Madagascar</li>
        <li>Mandy</li>
        <li>Mars Attacks!</li>
        <li>MasterMovies Marathon</li>
        <li>Mean Streets</li>
        <li>Megamind</li>
        <li>Men in Black</li>
        <li>Minority Report</li>
        <li>Monsters vs Aliens</li>
        <li>Mr. Bean Complete Series</li>
        <li>Mummy returns</li>
        <li>National Treasure</li>
        <li>Natural Born Killers</li>
        <li>New Kids Turbo + Nitro</li>
        <li>New York, New York</li>
        <li>New York Stories</li>
        <li>Nicolas Cage Marathon (Face-off, Con-Air, The Rock)</li>
        ...
        <li>Pirates of the Caribbean Marathon (1-5)</li>
        <li>Place Beyond the Pines</li>
        <li>Plan 9 From Outer Space</li>
        <li>Planet 51</li>
        <li>Predator 2</li>
        <li>Raging Bull</li>
        <li>Red Obsession</li>
        <li>Reqium For a Dream</li>
        <li>Reservoir Dogs</li>
        <li>Riddick</li>
        <li>Robin hood man in tights</li>
        <li>Robocop</li>
        <li>Robots</li>
        <li>Rogue One</li>
        <li>Rush hour</li>
        ...
        <li>Silence</li>
        <li>Shark boy and lava girl</li>
        <li>Shattered Glass</li>
        <li>Shawshank Redemption</li>
        <li>Sherlock Holmes 1 & 2</li>
        <li>Shindler's List</li>
        ...
        <li>Soul Assassin</li>
        <li>Space balls</li>
        <li>Space Jam marathon</li>
        <li>Splice</li>
        <li>Star Wars Marathon</li>
        <li>Starship troopers</li>
        <li>Stories USA (2007)</li>
        <li>Street Fighter</li>
        <li>Super hero movie</li>
        ...
        <li>The Green Inferno</li>
        <li>The Green Mile</li>
        <li>The Host 2006</li>
        <li>The Hitcher (Rutger Hauer)</li>
        <li>The Irishman</li>
        <li>The king of comedy</li>
        <li>The Lair of the white worm</li>
        <li>The Ladykillers</li>
        <li>The Last Temptation of Christ</li>
        <li>The Librarian marathon</li>
        <li>The Lobster</li>
        ...
        <li>They Live</li>
        <li>Tomb Raider marathon</li>
        <li>Tombstone</li>
        <li>Top Secret</li>
        <li>Total Recall double Feature</li>
        <li>Transformers Marathon</li>
        <li>Tremors 2</li>
        <li>Troy</li>
        <li>Unbreakable</li>
        <li>Uncut Gems</li>
        <li>Uncut WWE afleveringen (HD) (V.a. Seizoen 1)</li>
        <li>Under the skin</li>
        <li>Vampires Suck</li>
        <li>War of the worlds</li>
        <li>White bo rick</li>
        <li>Who's That Knocking at My Door</li>
        <li>Wickerman</li>
        <li>Wild Wild West</li>
        <li>Willy Wonka &  the Chocolate Factory</li>
        <li>Wish Dragon</li>
        <li>X-Men: Origins Wolverine</li>
        <li>You're next</li>
        <li>Zardoz</li>
        <li>Zombie Ninjas vs Black Ops</li>
        <li>Zoolander</li>
        <li>Zootopia (Furry paradise)</li>
        <li>Zorro</li>
      </ul>
    </div>
    <div class="column">
